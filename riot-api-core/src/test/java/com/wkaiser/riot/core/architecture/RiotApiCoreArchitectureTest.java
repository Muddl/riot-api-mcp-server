package com.wkaiser.riot.core.architecture;
 ...
 *
 * <p>Before the monorepo split, one scan root covered {@code com.wkaiser.riotapimcpserver}, so the
 ...
 */
@AnalyzeClasses(
        packages = "com.wkaiser.riot.core",
